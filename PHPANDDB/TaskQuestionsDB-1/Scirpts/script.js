$(document).ready(function () {
    ...
    $("#startAdding").click(function () {
        ...
        if (!isNaN(numberOfQuestions) && numberOfQuestions <= 10 && numberOfQuestions > 0) {
            ...
            addQuestionLabels(questionsToAdd, numberOfQuestions, parentElement);
    ...
    */
    function addQuestionLabels(number, questionNum, parentElement) {
        ...
        for (let i = 0; i < number; i++) {
            ...
            const choiceInput1 = $("<input>").attr("type", "text").attr("placeholder", "Choice").attr("required", "required").attr("name", `choice${(questionNum + i - number)}[]`);
